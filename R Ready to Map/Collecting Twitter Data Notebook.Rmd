...
<b>1. To understand the the Twitter API used for collecting data.</b>
...
Consumer Secret(API secret), Access Token and Access Token Secret. Put this information within the quotes.
...
`t <- 60 * 60 * 24 * 4` means to search for tweets for a period of three days.
